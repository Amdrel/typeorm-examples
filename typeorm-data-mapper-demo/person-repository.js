...
var PersonRepository = /** @class */ (function (_super) {
    __extends(PersonRepository, _super);
    function PersonRepository() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    PersonRepository.prototype.findByName = function (fullname) {
        return this.createQueryBuilder("people")
            .where("people.fullname = :fullname", { fullname: fullname })
            .getOne();
    };
    PersonRepository.prototype.updateName = function (id, fullname) {
        return this.createQueryBuilder("people")
            .update()
