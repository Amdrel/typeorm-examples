...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var connection, newPerson, existingPerson;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                _a.sent();
                return [4 /*yield*/, person_1.Person.findByName("Jane Doe")];
            case 3:
                ...
                return [4 /*yield*/, existingPerson.updateName("Jane Johnson")];
            case 4:
                // Change the person's full name.
                _a.sent();
                // Remove the person from the database.
                return [4 /*yield*/, existingPerson.remove()];
            case 5:
                // Remove the person from the database.
                _a.sent();
